...
export const Card = ({ rotate, scale, translate }: { rotate: any; scale: any; translate: any }) => {
  return (
    <motion.div
      ...
      className="max-w-7xl -mt-24 md:-mt-10 mx-auto h-[30rem] md:h-[40rem] w-full p-6 bg-[#222222] rounded-[30px] shadow-2xl "
    >
      <div className="bg-gray-100 h-full w-full rounded-2xl gap-4 overflow-hidden p-4 transition-all ">
        <Image src="/assets/temp-banner.png" fill alt="bannerImage" className="object-cover border-8 rounded-2xl" />
      </div>
    </motion.div>
  );
};
