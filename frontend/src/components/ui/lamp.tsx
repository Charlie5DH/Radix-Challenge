  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-10 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-7xl"
      >
        Real time
        <br /> monitoring for your sensors
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <div
      className={cn(
        "relative flex min-h-[900px] flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full rounded-md z-0",
        className
      )}
    >
